...
urlpatterns = [
    ...
    path('application_test/', views.application_test, name='application_test'),
    path('application_test_change/<int:pk>', views.application_test_change, name='application_test_change'),
